  ...
  Widget _buildAddEquipmentForm() {
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            Text('Add Equipment', style: TextStyle(fontWeight: FontWeight.bold)),
            TextField(
  ...
  Widget _buildAddInventoryForm() {
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            Text('Add Inventory', style: TextStyle(fontWeight: FontWeight.bold)),
            TextField(
  ...
  Widget _buildAddWorkerForm() {
    return Card(
      child: Padding(
        ...
        child: Column(
          children: [
            Text('Add Worker Category', style: TextStyle(fontWeight: FontWeight.bold)),
            TextField(
